...
#SBATCH --nodes=3                # Select the number of nodes
...
#SBATCH --job-name=mpi-12gpu-detr-test
##------------------------ End job description ------------------------

module purge
module load eb/OpenMPI/gcc/4.0.0
source /gws/nopw/j04/sensecdt/users/mespi/virtualenvs/ref_sam/bin/activate
...
mpirun \
    ...
    python tools/test.py work_configs/RefSAM_det_coco_base.py \
            work_dirs/RefSAM_det_coco_base/epoch_50.pth \
            --launcher mpi
#            --show
#            --resume-from work_dirs/l3_36_dwBN1_directB/latest.pth \
