...
model = dict(
    ...
    sam=dict(
        ...
        checkpoint="/work/scratch-nopw2/mespi/sam-hq-hf/sam-hq-training/pretrained_hq_sam/sam_hq_vit_h.pth"
    ),
    neck=dict(
        type='ChannelMapper',
        in_channels=[1280, 1280, 1280, 1280],  # 768 for vit_b, 1024 for vit_l, 1280 for vit_h
        kernel_size=1,
        out_channels=256,
        act_cfg=None,
...
val_evaluator = dict(
    ...
    # outfile_prefix='./work_dirs/RefSAM_det_coco_base_huge/RefSAM_det_coco_base_huge',  # Prefix for saving the JSON file
    backend_args=backend_args)
